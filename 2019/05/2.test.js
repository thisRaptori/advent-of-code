...
describe("compute", () => {
  ...
  it("should work for jump tests", () => {
    ...
    // prettier-ignore
    const jumpP = compute(3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9);
  ...
  it("should work for the larger example", () => {
    // prettier-ignore
    const compareToEight = compute(3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36, 98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104, 999, 1105, 1, 46, 1101, 1000, 1, 20, 4, 20, 1105, 1, 46, 98, 99);
